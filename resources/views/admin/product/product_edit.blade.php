                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <textarea name="short_desc_en" class="form-control" rows="10" cols="10">{!! $products->short_desc_en !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="long_desc_en" id="editor1" class="form-control" rows="10" cols="80">{!! $products->long_desc_en !!}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- End 7th Row -->
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        <div class="box-header">
                            <h4 class="box-title">Product Featured Image <strong>Update</strong></h4>
                        </div>

                        <form action="{{ route('update-product-thambnail') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $products->id }}">
                            <input type="hidden" name="old_img" value="{{ $products->product_thambnil }}">
                            <div class="row">

                                <div class="col-md-3">
                                    <div class="box-body">
                                        <div class="card">
                                            <img class="card-img-top" src="{{ asset($products->product_thambnil) }}"
                                                alt="Card image" style="width:400px;height:180px;">
                                            <div class="card-body">
                                                <h4 class="card-title">
                                                    <a href="" class="btn btn-danger" title="Delete Image"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        ...
                        <form action="{{ route('update-product-image') }}" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                        <a href="{{ route('product.multiimg.delete', $img->id) }}"
                                                            class="btn btn-danger" title="Delete Image" id="delete">
