                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="form-group">
                                <label class="info-title" for="reg_email">Email Address <span>*</span></label>
                                <input type="email"
                                    class="form-control unicase-form-control text-input  @error('email') is-invalid @enderror"
                                    name="email" id="reg_email" value="{{ old('email') }}" autocomplete="email">
                                @error('email')
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control unicase-form-control text-input" id="password2"
