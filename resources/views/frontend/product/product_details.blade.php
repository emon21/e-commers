                        ...
                        <div class="row  wow fadeInUp">
                            ...
                            <div class='col-sm-6 col-md-7 product-info-block'>
                                <div class="product-info">
                                    ...
                                    <div class="description-container m-t-20 text-justify">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                {{-- <a href="#" class="btn btn-primary"><i
                                                        class="fa fa-shopping-cart inner-right-vs" onclick="addToCart()"></i> ADD TO CART</a> --}}
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="description" class="tab-pane in active">
                                        <div class="product-tab text-justify">
                                    ...
                                    <div id="tags" class="tab-pane">
                                        <div class="product-tag">
                                            ...
                                            <form role="form" class="form-inline form-cnt">
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <span class="text col-md-offset-3"> spaces to separate tags
                                                    </span>
                                                </div>
                                            </form><!-- /.form-cnt -->
